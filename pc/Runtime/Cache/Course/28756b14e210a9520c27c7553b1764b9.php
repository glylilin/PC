...
<div class="bodyauto">
	<div class="vcourse_location fullWidth"><a href="#">首页</a><span>&gt;</span><a href="#">VIP课程</a><span>&gt;</span><?php echo ($data["name"]); ?></div>
	<div class="whiteBg fullWidth">
		<script type="text/javascript" src="js/paixu.js"></script>
		<dl class="vcourse_rank fullWidth">
			<dt>私教</dt>
			<dd>
				<p onclick="paixu(0)">综合排序</p><p onclick="paixu(1)">热门</p><p onclick="paixu(2)">价格<em><i class="top"></i><i class="bottom"></i></em></p>
			</dd>
		</dl>
		<ul class="vcourse_list1 fullWidth">
		<?php if(is_array($data["child"])): foreach($data["child"] as $key=>$id): ?><li>
				<div class="box">
					<div class="pic">
						<a href="<?php echo ($id["id"]); ?>" title="">
							<img originalsrc="<?php echo ($id["thumbpath"]); ?>"  src="/Public/static/common/images/defaultpic.gif" alt="" class="lazy">
					...
					<p class="price">￥<b class="jiage"><?php echo ($id["price"]); ?></b>/VIP2:￥<?php echo ($id["vip_price"]); ?></p>
				</div>
